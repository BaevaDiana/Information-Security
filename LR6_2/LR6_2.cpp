...
//Составить программу, которая по заданным n, m и A[1:n; 1:m] подбирает такие значения для элементов массивов LS и LO,
//чтобы компьютерная система CS = (n, m, A, LS, LO) удовлетворяла критерию безопасности Белла – Лападулы 
//или сообщала, что при заданной матрице A[1:n; 1:m] требуемых наполнений массивов LS и LO не существует.
